...
- **Стиль путей**: Plural + Nested Resources ✅
...
GET    /api/users/{id}/employee   ← Получить профиль сотрудника
GET    /api/users/{id}/employer   ← Получить профиль работодателя
...
GET    /api/employees/{id}/resume        ← Получить резюме сотрудника
...
GET    /api/employers/{id}/vacancies     ← Вакансии работодателя
