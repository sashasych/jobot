...
GET    /api/users/{UserID}/employee    # Получить профиль сотрудника пользователя
GET    /api/users/{UserID}/employer    # Получить профиль работодателя пользователя
...
GET    /api/employees/{EmployeeID}/resume      # Получить резюме сотрудника
...
GET    /api/employers/{EmployerID}/vacancies    # Получить вакансии работодателя
